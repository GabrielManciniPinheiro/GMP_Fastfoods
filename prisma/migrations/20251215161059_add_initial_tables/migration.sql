-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'IN_PREPARATION', 'PAYMENT_CONFIRMED', 'PAYMENT_FAILED', 'FINISHED', 'CANCELED');

-- CreateEnum
CREATE TYPE "ConsumptionMethod" AS ENUM ('PICKUP', 'TAKEAWAY', 'DELIVERY');
